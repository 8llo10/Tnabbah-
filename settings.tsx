                ...
                const onMessage = (topic: string, message: Buffer) => {
                    ...
                    try {
                        ...
                        if (data?.obdConnected && incomingCarId) {
                            ...
                            saveSelectedCarId(incomingCarId);
                    ...
                    <View style={[styles.settingRow, { flexDirection: rowDirection }]}>
                        ...
                        >
                            ...
                            <View style={[styles.labelBlock, { alignItems }]}>
                                ...
                                >
                                    {userCars.find((car) => car.car_id === selectedCarId)?.display_name ||
                                        selectedCarId ||
                                        t.noCar}
                                </Text>
                            </View>
    ...
    {connectedCarId
        ? selectedLanguage === "AR"
            ? `السيارة المتصلة الآن: ${
                  userCars.find((car) => car.car_id === connectedCarId)?.display_name ||
                  connectedCarId
              }`
            : `Connected now: ${
                  userCars.find((car) => car.car_id === connectedCarId)?.display_name ||
            ...
            : "No car is connected now"}
                    ...
                    {carsLoading ? (
                        ...
                        <View style={{ marginTop: 12, gap: 12 }}>
                            {userCars.map((car) => {
                                const isCurrent = selectedCarId === car.car_id;
