...
class PIDAnomaly(BaseModel):
    ...
    professional_explanation: Optional[str] = Field(None, description="Professional technical explanation in Arabic")
    ...
    trend: Optional[str] = Field(None, description="STABLE, INCREASING, DECREASING, OSCILLATING")
    action_priority: Optional[str] = Field("SOON", description="MONITOR, SOON, URGENT, CRITICAL")
...
class LearningState(BaseModel):
    ...
    system_health_history: List[Dict[str, float]]  # Historical scores
    last_updated: datetime = Field(default_factory=datetime.now)
