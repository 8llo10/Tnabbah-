            ...
            >
                ...
                >
                    <View style={styles.screenContent}>
                        {/* زر الرجوع يرجع إلى Forgot Password */}
                        <TouchableOpacity
                                            ...
                                            colors={
                                                hasError
                                                    ? [
                                                          ...
                                                          'rgba(255,238,238,0.92)',
                                                      ]
                                                    : isFilled
                                                      ? [
                                                            'rgba(255,247,246,0.98)',
                                                            'rgba(255,235,232,0.92)',
                                                        ]
                                                      : [
                                                            'rgba(255,255,255,0.96)',
                                                            'rgba(255,241,238,0.86)',
...
const styles = StyleSheet.create({
    ...
    // نفس زر الرجوع في Login / Sign up / Forgot Password
    backButtonWrapper: {
        position: 'absolute',
        top: height * 0.105,
        left: 24,
    ...
    otpBoxFocused: {
        borderColor: 'rgba(135, 27, 23, 0.52)',
        shadowColor: '#871B17',
