...
export default function StartScreen() {
    ...
    /*
        مكان اللوغو النهائي فوق اليمين.
        عدلناها عشان يكون مقابل زر EN وما يدخل برا الشاشة.
    */
    const finalLogoLeft = width - 24 - logoEndWidth - 18;
    const finalLogoTop = height * 0.105 - 6;

    /*
        تعويض فرق الحجم بسبب scale.
        مهم عشان اللوغو النهائي يوقف في المكان الصح.
    */
    ...
    return (
        <View style={styles.container}>
            {/* 
                الواجهة كلها هنا مخفية في البداية.
                عشان أول شيء يظهر فقط اللوغو والخلفية البيضاء.
            */}
            <Animated.View
                style={[
                    styles.fullContent,
            ...
            {/* 
                هذا اللوغو الوحيد.
                يبدأ بالنص كبير، بعدين يصغر ويوقف مكان اللوغو فوق.
            */}
            <Animated.Image
...
const styles = StyleSheet.create({
    ...
    carSection: {
        ...
        /*
            مهم:
            لأن container فيه paddingHorizontal: 24
            عوضناها بـ -24 عشان السيارة والدوائر يتطابقون.
        */
        left: width / 2 - (width * 0.66) / 2 - 24,
